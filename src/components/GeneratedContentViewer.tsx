        ...
        <div className="mt-8">
            <div className="relative flex border-b border-neutral-800">
                {tabs.map((length) => (
                    <button
                        ...
                        className={`relative z-10 px-4 py-2 text-sm font-medium transition-colors duration-300 ${selectedLength === length ? "text-white" : "text-neutral-400 hover:text-white"}`}
                    >
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className="mt-4 p-6 bg-neutral-800 rounded-lg border border-neutral-700"
                >
                    {selectedContent ? (
