      ...
      <main className="flex-1">
        <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10">
            <div className="absolute -top-1/2 -left-1/2 w-96 h-96 bg-blue-500/20 rounded-full filter blur-3xl animate-pulse"></div>
            <div className="absolute -bottom-1/2 -right-1/2 w-96 h-96 bg-purple-500/20 rounded-full filter blur-3xl animate-pulse animation-delay-4000"></div>
          </div>
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-300 mb-10">
                Kontext uses GenAI to transform complex technology news into clear, concise, and engaging blog posts. Stay informed, effortlessly.
              </p>
              <Link href="/news">
        ...
        <section className="py-20 bg-gray-900/50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {featureCard('Multiple Formats', 'From quick summaries to in-depth explanations, choose the format that fits your needs.')}
              {featureCard('Real-time Updates', 'Our cron jobs fetch the latest news every hour, so you never miss a beat.')}
              {featureCard('Personalized Experience', 'Bookmark articles and tailor your feed to your interests (coming soon!).')}
