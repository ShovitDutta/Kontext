    ...
    if (!session) {
        return (
            <div className="flex items-center justify-center min-h-[calc(100vh-14rem)]">
                ...
                >
                    <h1 className="text-2xl font-bold text-center text-white">Welcome to Kontext</h1> <p className="text-center text-gray-400">Sign in with your Google account to continue.</p>
                    <button
                        ...
                        >
                            ...
                            <Link href="/news">
                                <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-transform transform hover:scale-105 inline-flex items-center space-x-2">
                                    <span>Explore News</span> <FaArrowRight className="h-5 w-5" />
                                </button>
                            </Link>
                        </motion.div>
                    </div>
